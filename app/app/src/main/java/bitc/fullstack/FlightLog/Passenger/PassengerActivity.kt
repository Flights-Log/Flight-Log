package bitc.fullstack.FlightLog.Passenger
...
//      다이얼로그 띄우기
  ...
  private fun addNewPassengerForm(){
    ...
    val newPassengerLayout = layoutInflater.inflate(R.layout.passenger_form, null) as LinearLayout
...
//      다이얼로그 띄우기
    ...
    val phoneNumberEditText = newPassengerLayout.findViewById<EditText>(R.id.passenger_phone_number)
  ...
  private fun savePassengerInfo(){
    passengerViews.forEach{ passengerLayout ->
      ...
      Log.d("Passenger Info", "$lastName $firstName, $gender, $nationality, $birthDate, $passportNumber, $phoneNumber, $baggageWeight")
    }
  }
}